...
const { registerSchema, loginSchema, mPinSchema } = require('../helpers/validation_schema');
...
module.exports = {
    register: async (req, res, next) => {
        try {
            ...
            res.send({ username: saveUser.username, accessToken, refreshToken, userId: saveUser.id, mPinSet: false });
        } catch (error) {
